<?php
/**
 * mini.php - Página específica Mini Masculí Liga 3x3 2025
 * CORREGIDO: Sin warnings, sistema V=2pts D=1pt unificado
 * ADAPTADO: Para categoría Mini Masculí con colores y características propias
 */
...
// Obtener información de la categoría Mini Masculí
$categoria_id = null;
$categoria_nom = 'MINI MASCULÍ';
...
if (!$categoria_id) {
    die("Categoría Mini Masculí no encontrada");
}

// Obtener todos los partidos de Mini Masculí
try {
    $stmt = $pdo->prepare("
...
// Obtener equipos de Mini Masculí (EXCLUYENDO equipos especiales de finales)
try {
    $stmt = $pdo->prepare("
        SELECT e.Nom 
        FROM equips e 
...
<head>
    ...
    <title>Mini Masculí - Liga 3x3 2025</title>
...
<body>
        ...
        <div class="nav-container">
            <ul class="nav-menu">
                ...
                <li class="nav-item active">
                    <a href="mini.php" class="nav-link">
                        <i class="fas fa-child"></i> <span>Mini Masculí</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="page-title">
            <h2><i class="fas fa-child"></i> Mini Masculí</h2>
        ...
        <!-- Información sobre las finales (ESPECÍFICA para Mini) -->
        <div class="finals-info">
            <h3><i class="fas fa-trophy"></i> Informació Important</h3>
            <p><strong>EN LA CATEGORIA MINI MASCULÍ, HI HAURÀ FINAL ENTRE ELS 2 PRIMERS CLASSIFICATS DE LA LLIGUETA</strong></p>
        </div>
        ...
        <div class="section">
            <h3><i class="fas fa-list-alt"></i> Partits de Mini Masculí</h3>
        ...
        <!-- Clasificación (CORREGIDA - sin warnings, sin empates) -->
        <div class="section">
            <h3><i class="fas fa-medal"></i> Classificació Mini Masculí</h3>
            ...
            <?php if (!empty($clasificacion) && $partidos_jugados > 0): ?>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            foreach ($clasificacion as $equipo): 
                                $is_finalist = ($position <= 2); // Los 2 primeros van a final en Mini
                            ?>
                ...
                <div class="classification-legend">
                    <p><i class="fas fa-star" style="color: #D2691E;"></i> <strong>Els 2 primers classificats disputaran la final</strong></p>
        ...
        <!-- INFORMACIÓN sobre el partido de final si existe -->
        <?php if ($final_partido): ?>
            <div class="section" style="background: linear-gradient(135deg, #ffd700, #ffed4e); border: 3px solid #D2691E;">
                <h3 style="color: #8B4513; text-align: center;"><i class="fas fa-trophy"></i> Final Mini Masculí</h3>
                ...
                <div style="text-align: center; padding: 20px;">
                    ...
                    <div style="font-size: 1.5em; margin-bottom: 15px; color: #8B4513;">
                        <strong><?php echo htmlspecialchars($final_partido['EquipLocal']); ?></strong>
                        <span style="margin: 0 20px; font-size: 1.2em; color: #D2691E;">
                    ...
                    <?php if ($final_sin_jugar): ?>
                        <div style="background: #D2691E; color: white; padding: 10px 20px; border-radius: 25px; display: inline-block; font-weight: bold;">
                            🏆 FINAL PROGRAMADA
                        </div>
                        <?php if ($final_partido['Pista']): ?>
                            <p style="margin-top: 10px; color: #8B4513;">
    ...
    <script>
        // Efectos de hover para las tarjetas de equipos (ya definidos en CSS)
        ...
        // Resaltar fila de clasificación al hover (ya definido en CSS)
        ...
        if (window.location.hostname === 'localhost') {
            console.log('🏀 Mini Masculí - Liga 3x3 2025 (CORREGIDO)');
            ...
            console.log('🎨 Color temático: #FCD5B4 (beige/crema)');
        }
    </script>
</body>
</html>