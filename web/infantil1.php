<?php
/**
 * infantil1.php - Página específica Infantil Masculí Grup 1 Liga 3x3 2025
...
// Obtener información de la categoría Infantil Masculí Grup 1
$categoria_id = null;
$categoria_nom = 'INFANTIL MASCULÍ GRUP 1';
...
if (!$categoria_id) {
    die("Categoría Infantil Masculí Grup 1 no encontrada");
}

// Obtener todos los partidos de Infantil Masculí Grup 1
try {
    $stmt = $pdo->prepare("
...
// Obtener equipos de Infantil Masculí Grup 1 (EXCLUYENDO equipos especiales de finales)
try {
    $stmt = $pdo->prepare("
        SELECT e.Nom 
        FROM equips e 
...
<head>
    ...
    <title>Infantil Masculí Grup 1 - 3x3 Memorial Joan Hernández Gómez</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="../css/infantil1.css">
</head>
<body>
    <header>
        ...
        <div class="nav-container">
            <ul class="nav-menu">
                ...
                <li class="nav-item active">
                    <a href="infantil1.php" class="nav-link">
                        <i class="fas fa-trophy"></i> <span>Infantil Grup 1</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="page-title">
            <h2><i class="fas fa-running"></i> Infantil Masculí Grup 1</h2>
        ...
        <div class="finals-info">
            ...
            <p><strong>EN LA CATEGORIA INFANTIL MASCULÍ GRUP 1, ELS 2 PRIMERS CLASSIFICATS DISPUTARAN LA FINAL CONTRA ELS 2 PRIMERS DEL GRUP 2</strong></p>
        </div>
        ...
        <div class="section">
            <h3><i class="fas fa-list-alt"></i> Partits d'Infantil Masculí Grup 1</h3>
        ...
        <div class="section">
            <h3><i class="fas fa-medal"></i> Classificació Infantil Masculí Grup 1</h3>
            ...
            <?php if (!empty($clasificacion) && $partidos_jugados > 0): ?>
                ...
                <div class="classification-legend">
                    <p><i class="fas fa-star" style="color: #1976D2;"></i> <strong>Els 2 primers classificats disputaran la final contra els 2 primers del Grup 2</strong></p>
        ...
        <?php if ($final_partido): ?>
            <div class="section" style="background: linear-gradient(135deg, #C5D9F1, #E3F2FD); border: 3px solid #1976D2;">
                <h3 style="color: #0D47A1; text-align: center;"><i class="fas fa-trophy"></i> Final Infantil Masculí</h3>
                ...
                <div style="text-align: center; padding: 20px;">
                    ...
                    <div style="font-size: 1.5em; margin-bottom: 15px; color: #0D47A1;">
                        <strong><?php echo htmlspecialchars($final_partido['EquipLocal']); ?></strong>
                        <span style="margin: 0 20px; font-size: 1.2em; color: #1976D2;">
                    ...
                    <?php if ($final_sin_jugar): ?>
                        <div style="background: #1976D2; color: white; padding: 10px 20px; border-radius: 25px; display: inline-block; font-weight: bold;">
                            🏆 FINAL PROGRAMADA
                        </div>
    ...
    <script>
        ...
        if (window.location.hostname === 'localhost') {
            console.log('🏀 Infantil Masculí Grup 1 - Liga 3x3 2025');
