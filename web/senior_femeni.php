<?php
/**
 * senior_femeni.php - Página específica Senior Femení Liga 3x3 2025
...
// Obtener información de la categoría Senior Femení
$categoria_id = null;
$categoria_nom = 'SENIOR FEMENÍ';
...
if (!$categoria_id) {
    die("Categoría Senior Femení no encontrada");
}

// Obtener todos los partidos de Senior Femení
try {
    $stmt = $pdo->prepare("
...
// Obtener equipos de Senior Femení (EXCLUYENDO equipos especiales de finales)
try {
    $stmt = $pdo->prepare("
        SELECT e.Nom 
        FROM equips e 
...
<head>
    ...
    <title>Senior Femení - 3x3 Memorial Joan Hernández Gómez</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="../css/senior_femeni.css">
</head>
<body>
    <header>
        ...
        <div class="nav-container">
            <ul class="nav-menu">
                ...
                <li class="nav-item active">
                    <a href="senior_femeni.php" class="nav-link">
                        <i class="fas fa-trophy"></i> <span>Senior Femení</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="page-title">
            <h2><i class="fas fa-user-graduate"></i> Senior Femení</h2>
        ...
        <div class="finals-info">
            ...
            <p><strong>EN LA CATEGORIA SENIOR FEMENÍ, ELS 2 PRIMERS CLASSIFICATS DISPUTARAN LA FINAL</strong></p>
        </div>
        ...
        <div class="section">
            <h3><i class="fas fa-list-alt"></i> Partits de Senior Femení</h3>
        ...
        <div class="section">
            <h3><i class="fas fa-medal"></i> Classificació Senior Femení</h3>
            ...
            <?php if (!empty($clasificacion) && $partidos_jugados > 0): ?>
                ...
                <div class="classification-legend">
                    <p><i class="fas fa-star" style="color: #00796B;"></i> <strong>Els 2 primers classificats disputaran la final</strong></p>
        ...
        <?php if ($final_partido): ?>
            <div class="section" style="background: linear-gradient(135deg, #B2DFDB, #E0F2F1); border: 3px solid #00796B;">
                <h3 style="color: #004D40; text-align: center;"><i class="fas fa-trophy"></i> Final Senior Femení</h3>
                ...
                <div style="text-align: center; padding: 20px;">
                    ...
                    <div style="font-size: 1.5em; margin-bottom: 15px; color: #004D40;">
                        <strong><?php echo htmlspecialchars($final_partido['EquipLocal']); ?></strong>
                        <span style="margin: 0 20px; font-size: 1.2em; color: #00796B;">
                    ...
                    <?php if ($final_sin_jugar): ?>
                        <div style="background: #00796B; color: white; padding: 10px 20px; border-radius: 25px; display: inline-block; font-weight: bold;">
                            🏆 FINAL PROGRAMADA
                        </div>
                        <?php if ($final_partido['Pista']): ?>
                            <p style="margin-top: 10px; color: #004D40;">
                    ...
                    <?php else: ?>
                        <div style="background: #28a745; color: white; padding: 10px 20px; border-radius: 25px; display: inline-block; font-weight: bold;">
                            🏆 CAMPIONA: <?php echo htmlspecialchars($final_ganador); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <script>
        ...
        document.querySelectorAll('.classification-table tbody tr').forEach(row => {
            row.addEventListener('mouseenter', function() {
                this.style.backgroundColor = 'rgba(0, 121, 107, 0.1)';
            });
        ...
        if (window.location.hostname === 'localhost') {
            console.log('🏀 Senior Femení - Liga 3x3 2025');
