<?php
/**
 * premini.php - Página específica Pre-Mini Mixte Liga 3x3 2025
...
// Obtener información de la categoría Pre-Mini
$categoria_id = null;
$categoria_nom = 'PREMINI MIXTE';
...
if (!$categoria_id) {
    die("Categoría Pre-Mini no encontrada");
}

// Obtener todos los partidos de Pre-Mini
try {
    $stmt = $pdo->prepare("
...
// Obtener equipos de Pre-Mini (EXCLUYENDO equipos especiales de finales)
try {
    $stmt = $pdo->prepare("
        SELECT e.Nom 
        FROM equips e 
...
<head>
    ...
    <title>Pre-Mini Mixte - 3x3 Memorial Joan Hernández Gómez</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="../css/premini.css">
</head>
<body>
    <header>
        ...
        <div class="nav-container">
            <ul class="nav-menu">
                ...
                <li class="nav-item active">
                    <a href="premini.php" class="nav-link">
                        <i class="fas fa-trophy"></i> <span>Pre-Mini</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="page-title">
            <h2><i class="fas fa-users"></i> Pre-Mini Mixte</h2>
        ...
        <div class="finals-info">
            ...
            <p><strong>EN LA CATEGORIA PRE-MINI MIXTE, HI HAURÀ FINAL ENTRE ELS 2 PRIMERS CLASSIFICATS DE LA LLIGUETA</strong></p>
        </div>
        ...
        <div class="section">
            <h3><i class="fas fa-list-alt"></i> Partits de Pre-Mini Mixte</h3>
        ...
        <div class="section">
            <h3><i class="fas fa-medal"></i> Classificació Pre-Mini Mixte</h3>
            ...
            <?php if (!empty($clasificacion) && $partidos_jugados > 0): ?>
                ...
                <div class="classification-legend">
                    <p><i class="fas fa-star" style="color: #ffd700;"></i> <strong>Els 2 primers classificats disputaran la final</strong></p>
        ...
        <?php if ($final_partido): ?>
            <div class="section" style="background: linear-gradient(135deg, #ffd700, #ffed4e); border: 3px solid #ffc107;">
                <h3 style="color: #856404; text-align: center;"><i class="fas fa-trophy"></i> Final Pre-Mini Mixte</h3>
                ...
                <div style="text-align: center; padding: 20px;">
                    ...
                    <div style="font-size: 1.5em; margin-bottom: 15px; color: #856404;">
                        <strong><?php echo htmlspecialchars($final_partido['EquipLocal']); ?></strong>
                        <span style="margin: 0 20px; font-size: 1.2em; color: #ff6b35;">
                    ...
                    <?php if ($final_sin_jugar): ?>
                        <div style="background: #ffc107; color: #000; padding: 10px 20px; border-radius: 25px; display: inline-block; font-weight: bold;">
                            🏆 FINAL PROGRAMADA
                        </div>
    ...
    <script>
        ...
        if (window.location.hostname === 'localhost') {
            console.log('🏀 Pre-Mini Mixte - Liga 3x3 2025 (CORREGIDO)');
