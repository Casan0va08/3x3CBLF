<?php
/**
 * veterans.php - Página específica Veterans Liga 3x3 2025
...
// Obtener información de la categoría Veterans Masculí
$categoria_id = null;
$categoria_nom = 'VETERANS MASCULÍ';
...
if (!$categoria_id) {
    die("Categoría Veterans Masculí no encontrada");
}

// Obtener todos los partidos de Veterans
try {
    $stmt = $pdo->prepare("
...
// Obtener equipos de Veterans (EXCLUYENDO equipos especiales de finales)
try {
    $stmt = $pdo->prepare("
        SELECT e.Nom 
        FROM equips e 
...
<head>
    ...
    <title>Veterans Masculí - 3x3 Memorial Joan Hernández Gómez</title>
...
<body>
        ...
        <div class="nav-container">
            <ul class="nav-menu">
                ...
                <li class="nav-item active">
                    <a href="veterans.php" class="nav-link">
                        <i class="fas fa-trophy"></i> <span>Veterans Masculí</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="page-title">
            <h2><i class="fas fa-medal"></i> Veterans Masculí</h2>
        ...
        <div class="finals-info">
            ...
            <p><strong>EN LA CATEGORIA VETERANS MASCULÍ, ELS 2 PRIMERS CLASSIFICATS DISPUTARAN LA FINAL</strong></p>
        </div>
        ...
        <div class="section">
            <h3><i class="fas fa-list-alt"></i> Partits de Veterans Masculí</h3>
        ...
        <div class="section">
            <h3><i class="fas fa-medal"></i> Classificació Veterans Masculí</h3>
            ...
            <?php if (!empty($clasificacion) && $partidos_jugados > 0): ?>
                ...
                <div class="classification-legend">
                    <p><i class="fas fa-star" style="color: #546E7A;"></i> <strong>Els 2 primers classificats disputaran la final</strong></p>
        ...
        <?php if ($final_partido): ?>
            <div class="section" style="background: linear-gradient(135deg, #90A4AE, #CFD8DC); border: 3px solid #546E7A;">
                <h3 style="color: #263238; text-align: center;"><i class="fas fa-trophy"></i> Final Veterans Masculí</h3>
                ...
                <div style="text-align: center; padding: 20px;">
                    ...
                    <div style="font-size: 1.5em; margin-bottom: 15px; color: #263238;">
                        <strong><?php echo htmlspecialchars($final_partido['EquipLocal']); ?></strong>
                        <span style="margin: 0 20px; font-size: 1.2em; color: #546E7A;">
                    ...
                    <?php if ($final_sin_jugar): ?>
                        <div style="background: #546E7A; color: white; padding: 10px 20px; border-radius: 25px; display: inline-block; font-weight: bold;">
                            🏆 FINAL PROGRAMADA
                        </div>
                        <?php if ($final_partido['Pista']): ?>
                            <p style="margin-top: 10px; color: #263238;">
    ...
    <script>
        ...
        document.querySelectorAll('.classification-table tbody tr').forEach(row => {
            row.addEventListener('mouseenter', function() {
                this.style.backgroundColor = 'rgba(84, 110, 122, 0.1)';
            });
        ...
        if (window.location.hostname === 'localhost') {
            console.log('🏀 Veterans Masculí - Liga 3x3 2025');
