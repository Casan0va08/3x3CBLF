<?php
/**
 * cadet.php - Página específica Cadet Liga 3x3 2025
...
// Obtener información de la categoría Cadet Masculí
$categoria_id = null;
$categoria_nom = 'CADET MASCULÍ';
...
if (!$categoria_id) {
    die("Categoría Cadet Masculí no encontrada");
}

// Obtener todos los partidos de Cadet
try {
    $stmt = $pdo->prepare("
...
// Obtener equipos de Cadet (EXCLUYENDO equipos especiales de finales)
try {
    $stmt = $pdo->prepare("
        SELECT e.Nom 
        FROM equips e 
...
<head>
    ...
    <title>Cadet Masculí - 3x3 Memorial Joan Hernández Gómez</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="../css/cadet.css">
</head>
<body>
    <header>
        ...
        <div class="nav-container">
            <ul class="nav-menu">
                ...
                <li class="nav-item active">
                    <a href="cadet.php" class="nav-link">
                        <i class="fas fa-trophy"></i> <span>Cadet Masculí</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="page-title">
            <h2><i class="fas fa-graduation-cap"></i> Cadet Masculí</h2>
        ...
        <div class="finals-info">
            ...
            <p><strong>EN LA CATEGORIA CADET MASCULÍ, ELS 2 PRIMERS CLASSIFICATS DISPUTARAN LA FINAL</strong></p>
        </div>
        ...
        <div class="section">
            <h3><i class="fas fa-list-alt"></i> Partits de Cadet Masculí</h3>
        ...
        <div class="section">
            <h3><i class="fas fa-medal"></i> Classificació Cadet Masculí</h3>
            ...
            <?php if (!empty($clasificacion) && $partidos_jugados > 0): ?>
                ...
                <div class="classification-legend">
                    <p><i class="fas fa-star" style="color: #7B1FA2;"></i> <strong>Els 2 primers classificats disputaran la final</strong></p>
        ...
        <?php if ($final_partido): ?>
            <div class="section" style="background: linear-gradient(135deg, #E1BEE7, #F3E5F5); border: 3px solid #7B1FA2;">
                <h3 style="color: #4A148C; text-align: center;"><i class="fas fa-trophy"></i> Final Cadet Masculí</h3>
                ...
                <div style="text-align: center; padding: 20px;">
                    ...
                    <div style="font-size: 1.5em; margin-bottom: 15px; color: #4A148C;">
                        <strong><?php echo htmlspecialchars($final_partido['EquipLocal']); ?></strong>
                        <span style="margin: 0 20px; font-size: 1.2em; color: #7B1FA2;">
                    ...
                    <?php if ($final_sin_jugar): ?>
                        <div style="background: #7B1FA2; color: white; padding: 10px 20px; border-radius: 25px; display: inline-block; font-weight: bold;">
                            🏆 FINAL PROGRAMADA
                        </div>
                        <?php if ($final_partido['Pista']): ?>
                            <p style="margin-top: 10px; color: #4A148C;">
    ...
    <script>
        ...
        document.querySelectorAll('.classification-table tbody tr').forEach(row => {
            row.addEventListener('mouseenter', function() {
                this.style.backgroundColor = 'rgba(123, 31, 162, 0.1)';
            });
        ...
        if (window.location.hostname === 'localhost') {
            console.log('🏀 Cadet Masculí - Liga 3x3 2025');
