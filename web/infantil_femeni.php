<?php
/**
 * infantil_femeni.php - Página específica Infantil Femení Liga 3x3 2025
...
// Obtener información de la categoría Infantil Femení
$categoria_id = null;
$categoria_nom = 'INFANTIL FEMENÍ';
...
if (!$categoria_id) {
    die("Categoría Infantil Femení no encontrada");
}

// Obtener todos los partidos de Infantil Femení
try {
    $stmt = $pdo->prepare("
...
// Obtener equipos de Infantil Femení (EXCLUYENDO equipos especiales de finales)
try {
    $stmt = $pdo->prepare("
        SELECT e.Nom 
        FROM equips e 
...
<head>
    ...
    <title>Infantil Femení - 3x3 Memorial Joan Hernández Gómez</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="../css/infantil_femeni.css">
</head>
<body>
    <header>
        ...
        <div class="nav-container">
            <ul class="nav-menu">
                ...
                <li class="nav-item active">
                    <a href="infantil_femeni.php" class="nav-link">
                        <i class="fas fa-trophy"></i> <span>Infantil Femení</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="page-title">
            <h2><i class="fas fa-female"></i> Infantil Femení</h2>
        ...
        <div class="finals-info">
            ...
            <p><strong>EN LA CATEGORIA INFANTIL FEMENÍ, ELS 2 PRIMERS CLASSIFICATS DISPUTARAN LA FINAL</strong></p>
        </div>
        ...
        <div class="section">
            <h3><i class="fas fa-list-alt"></i> Partits d'Infantil Femení</h3>
        ...
        <div class="section">
            <h3><i class="fas fa-medal"></i> Classificació Infantil Femení</h3>
            ...
            <?php if (!empty($clasificacion) && $partidos_jugados > 0): ?>
                ...
                <div class="classification-legend">
                    <p><i class="fas fa-star" style="color: #E91E63;"></i> <strong>Els 2 primers classificats disputaran la final</strong></p>
        ...
        <?php if ($final_partido): ?>
            <div class="section" style="background: linear-gradient(135deg, #F8BBD9, #FCE4EC); border: 3px solid #E91E63;">
                <h3 style="color: #AD1457; text-align: center;"><i class="fas fa-trophy"></i> Final Infantil Femení</h3>
                ...
                <div style="text-align: center; padding: 20px;">
                    ...
                    <div style="font-size: 1.5em; margin-bottom: 15px; color: #AD1457;">
                        <strong><?php echo htmlspecialchars($final_partido['EquipLocal']); ?></strong>
                        <span style="margin: 0 20px; font-size: 1.2em; color: #E91E63;">
                    ...
                    <?php if ($final_sin_jugar): ?>
                        <div style="background: #E91E63; color: white; padding: 10px 20px; border-radius: 25px; display: inline-block; font-weight: bold;">
                            🏆 FINAL PROGRAMADA
                        </div>
                        <?php if ($final_partido['Pista']): ?>
                            <p style="margin-top: 10px; color: #AD1457;">
    ...
    <script>
        ...
        if (window.location.hostname === 'localhost') {
            console.log('🏀 Infantil Femení - Liga 3x3 2025');
